...
La generalización inmediata de \eqref{c2n1} se tiene al extender $\X$ al plano $R^2$. Sea $A=[a,x]\times[b,y]$ entonces de \eqref{c2n0} se tiene
\begin{align*}
...
En el caso general, donde $\X=R^d$ y $S:\X\cir$ invertible, se puede derivar una interesante y útil generalización de
 la ecuación \eqref{c2n1}. Para hacer esto primero se probará el teorema del cambio de variable basado en el teorema de Radon-Nikodym.
